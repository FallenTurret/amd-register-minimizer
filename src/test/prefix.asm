...
prefix_sum:
.skip 256
/*000000000100*/ s_load_dwordx4  s[0:3], s[6:7], 0x0
/*000000000104*/ s_load_dwordx4  s[12:15], s[6:7], 0x4
/*000000000108*/ s_load_dword    s4, s[4:5], 0x1
/*00000000010c*/ v_lshlrev_b32   v7, 1, v0
/*000000000110*/ v_mov_b32       v2, 0
/*000000000114*/ s_mov_b32       s9, 0
/*000000000118*/ s_mov_b32       s19, 0xf000
/*000000000120*/ s_waitcnt       lgkmcnt(0)
/*000000000124*/ s_and_b32       s4, s4, 0xffff
/*00000000012c*/ s_lshl_b32      s6, s4, 1
/*000000000130*/ s_mul_i32       s7, s6, s8
/*000000000134*/ v_add_i32       v1, vcc, s7, v7
/*000000000138*/ v_lshl_b64      v[3:4], v[1:2], 2
/*000000000140*/ s_mov_b32       s18, s9
/*000000000144*/ s_mov_b64       s[16:17], s[0:1]
/*000000000148*/ buffer_load_dwordx2 v[5:6], v[3:4], s[16:19], 0 addr64
/*000000000150*/ s_mov_b32       s5, 1
/*000000000154*/ v_lshlrev_b32   v3, 3, v0
/*000000000158*/ s_mov_b32       m0, -1
/*00000000015c*/ v_or_b32        v4, 1, v7
/*000000000160*/ s_cmp_lt_i32    s4, 1
/*000000000164*/ s_waitcnt       vmcnt(0)
/*000000000168*/ ds_write2_b32   v3, v5, v6 offset1:1
/*000000000170*/ s_cbranch_scc1  .L484_0
/*000000000174*/ s_mov_b32       s5, 1
/*000000000178*/ s_mov_b32       s0, s4
/*00000000017c*/ s_branch        .L404_0
.L384_0:
/*000000000180*/ s_or_b64        exec, exec, s[10:11]
/*000000000184*/ s_lshr_b32      s0, s0, 1
/*000000000188*/ s_lshl_b32      s5, s5, 1
/*00000000018c*/ s_cmp_eq_u32    s0, 0
/*000000000190*/ s_cbranch_scc1  .L484_0
.L404_0:
/*000000000194*/ v_cmp_gt_u32    vcc, s0, v0
/*000000000198*/ s_waitcnt       lgkmcnt(0)
/*00000000019c*/ s_barrier
/*0000000001a0*/ s_and_saveexec_b64 s[10:11], vcc
/*0000000001a4*/ s_cbranch_execz .L384_0
/*0000000001a8*/ v_mul_lo_u32    v5, s5, v4
/*0000000001b0*/ s_lshl_b32      s1, s5, 2
/*0000000001b4*/ v_lshlrev_b32   v5, 2, v5
/*0000000001b8*/ v_add_i32       v5, vcc, -4, v5
/*0000000001bc*/ v_add_i32       v6, vcc, s1, v5
...
.L484_0:
/*0000000001e4*/ s_mov_b32       s10, 0
/*0000000001e8*/ v_cmp_eq_u32    vcc, 0, v0
/*0000000001ec*/ s_and_saveexec_b64 s[0:1], vcc
/*0000000001f0*/ s_cbranch_execz .L568_0
/*0000000001f4*/ s_lshl_b32      s6, s6, 2
/*0000000001f8*/ s_add_i32       s14, s6, -4
/*0000000001fc*/ v_mov_b32       v7, s14
/*000000000200*/ ds_read_b32     v8, v7
/*000000000208*/ s_lshl_b64      s[6:7], s[8:9], 2
/*00000000020c*/ s_mov_b32       s11, 0xf000
/*000000000214*/ v_mov_b32       v5, s6
/*000000000218*/ s_mov_b64       s[14:15], s[10:11]
/*00000000021c*/ v_mov_b32       v6, s7
/*000000000220*/ s_waitcnt       lgkmcnt(0)
/*000000000224*/ buffer_store_dword v8, v[5:6], s[12:15], 0 addr64
/*00000000022c*/ v_mov_b32       v5, 0
/*000000000230*/ ds_write_b32    v7, v5
.L568_0:
/*000000000238*/ s_or_b64        exec, exec, s[0:1]
/*00000000023c*/ s_cmp_eq_u32    s4, 0
/*000000000240*/ s_cbranch_scc1  .L708_0
/*000000000244*/ s_mov_b32       s0, 1
/*000000000248*/ s_branch        .L604_0
.L588_0:
/*00000000024c*/ s_or_b64        exec, exec, s[6:7]
/*000000000250*/ s_lshl_b32      s0, s0, 1
/*000000000254*/ s_cmp_gt_u32    s0, s4
/*000000000258*/ s_cbranch_scc1  .L708_0
.L604_0:
/*00000000025c*/ s_lshr_b32      s5, s5, 1
/*000000000260*/ v_cmp_gt_u32    vcc, s0, v0
/*000000000264*/ s_waitcnt       vmcnt(0) & expcnt(0) & lgkmcnt(0)
/*000000000268*/ s_barrier
/*00000000026c*/ s_and_saveexec_b64 s[6:7], vcc
/*000000000270*/ s_cbranch_execz .L588_0
/*000000000274*/ v_mul_lo_u32    v5, s5, v4
/*00000000027c*/ s_lshl_b32      s1, s5, 2
/*000000000280*/ v_lshlrev_b32   v5, 2, v5
/*000000000284*/ v_add_i32       v5, vcc, -4, v5
/*000000000288*/ v_add_i32       v6, vcc, s1, v5
...
/*0000000002dc*/ s_mov_b32       s7, 0xf000
/*0000000002e4*/ s_mov_b32       s6, 0
/*0000000002e8*/ s_mov_b64       s[4:5], s[2:3]
/*0000000002ec*/ s_waitcnt       lgkmcnt(0)
/*0000000002f0*/ buffer_store_dwordx2 v[3:4], v[0:1], s[4:7], 0 addr64
